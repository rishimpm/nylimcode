...
app_urls = {
    'App 2': 'http://10.195.176.89:8000/documentsummarizer',
...
dash_app.layout = html.Div([
    ...
    #html.A(html.Img(src='./assets/logout.png',style={'height': '30px','cursor':'pointer'}),href='https://qa.cfed.newyorklife.com/assets/nyllogout.html?nylogout&target=https://qa.ai.newyorklifeinvestments.com/',style={'display':'block','marginTop':'10px'})
