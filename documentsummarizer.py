API_BASE_URL='http://10.195.176.75:8000'#Change API url to point to DEV/QA/PROD accordingly
                    ...
                    html.Div(
                        [
                            ...
                            html.A(
                                ...
                                href='https://dev.cfed.newyorklife.com/assets/nyllogout.html?nylogout&target=https://dev.ai.newyorklifeinvestments.com/',
                            ),
...
def create_user_text_box(text_box_index, text_box_content, domino_username, filename_timestamp_readable, original_file_name, enable_chat_history):
    ...
    if enable_chat_history:
        new_session_divider_display = 'none' # shankar changes
...
def generate_log(tz_eastern, start_time, transferDateTime, timestamp_id, mode, submit_type, file_size, new_filename, user_input, results_paragraph, results_json_from_api=''):
    try:
        ...
        log_list = {
            "username":request.cookies.get('hostname','Guest'),# Retrieve the cookie set in backend for username
        ...
        #print("logging details: {}".format(log_list))
